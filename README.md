...
项目提供了详细的开发指南，位于 `development-guide/` 目录：

| 指南文件 | 内容描述 |
|---------|---------|
| Step01-项目初始化与环境搭建.md | 项目初始化、环境配置 |
| Step02-数据库表设计与实体创建.md | 数据库设计、实体创建 |
| Step03-用户认证与授权系统.md | JWT认证、登录注册 |
| Step04-RBAC权限管理系统.md | 权限控制、动态菜单 |
| Step05-管理员管理模块.md | 管理员CRUD操作 |
| Step06-管理员组管理模块.md | 管理员组管理 |
| Step07-用户管理模块.md | 用户管理功能 |
| Step08-用户组管理模块.md | 用户组管理 |
| Step09-日志管理模块.md | 操作日志、登录日志 |
| Step10-系统配置管理模块.md | 系统参数配置 |
| Step11-文件上传管理模块.md | 文件上传管理 |
| Step12-消息通知模块.md | 消息通知功能 |
| Step13-个人中心模块.md | 个人信息管理 |
| Step14-前端界面优化与响应式设计.md | 前端优化 |
| Step15-系统测试优化与部署.md | 测试与部署 |
